...
1. Objects remain primary — every node still instantiates exactly one core Object.  
1. Relations do the work — epistemic richness must cash out as graph structure, not just annotation.  
1. Qualia bind to Values or Signals — no free-floating emotional coloring.  
1. Time binds to dynamics — temporal fields matter most on Flow, Resonance, Conflict, and Recursion.  
