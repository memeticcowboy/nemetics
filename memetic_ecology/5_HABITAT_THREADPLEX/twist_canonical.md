...
**Key properties:**
- Directional distortion, not binding
- Does **not** store memory
- Does **not** claim identity
...
**Test:** Can this unwind *without explanation*?
- Yes → Twist
- No → Knot
...
Every Twist leaves residual force:
- **Lumemic:** Preserves unwindability, expands option space
- **Usurpenic:** Increases lock-in, contracts option space
