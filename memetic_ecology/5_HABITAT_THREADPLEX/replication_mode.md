# Replication Mode — Essential Term
...
What must be explained is why:
- The *same* Knots keep reappearing
- The *same* identities reform  
- The *same* norms re-stabilize
- Even after disruption, critique, or fatigue
...
**Danger signals:**
- Deviation repeatedly escalates toward coercion
- Norms harden faster than conditions change
- Legitimacy replaces usefulness as justification
...
At this point:
- Ψ no longer responds to gradient pressure
- Z collapses without Ω
- The Habitat becomes a **control surface**
...
Replication Mode is **not conscious choice**. It is enforced through:
- Reward structures
