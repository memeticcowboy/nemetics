...
Multiplicity interacts multiplicatively with:
- **Permeability** — can new Threads enter?
- **Binding Authority** — who controls which Threads knot?
- **Temporal Flexibility** — can established Knots loosen?
- **Replication Mode** — how are Threads encouraged to re-form?
