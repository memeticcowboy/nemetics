...
Cannot be accessed directly. Emerges when:
- Patterns approach exhaustion
- Structure approaches dissolution
- The question becomes more important than the answer
- ε is maximized, not minimized
...
Either:
- **Functional:** Ω-permeable
- **Absent:** Collapsed into another Habitat
