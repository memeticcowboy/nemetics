...
When observing circulation:
1. **Which regime is dominant?** (Ω, χ, Q, Ψ, Z)
2. **In which Habitat does it express?** (ᖺ, ◎, etc.)
3. **Is ⊕_harmonic active?** (Ω-permeability)
