...
A Co-SPHERE emerges when a **Threadplex** stabilizes sufficiently that its affordances feel shared:
- Threads converge
- Knots align
- Action becomes legible at scale
...
A Co-SPHERE functions as:
- A **coordination basin**, not a belief system
- A **shared action horizon**, not a worldview monopoly
- A **permeable public**, not an enclosure
...
A Co-SPHERE fails when:
- Closure is claimed as ground
- Exits are blocked
- Dissent requires force
- Ω is silenced
