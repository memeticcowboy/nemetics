# Gradient Path — Complicated Term
...
**Appears as:**
- Affective pull ("this keeps returning")
- Somatic readiness (tension, leaning, recoil)
- Temporal bias (anticipation, dread, momentum)
- Amplitude differences (some experiences feel "heavier")
- Phase alignment/misalignment with present moment
...
This preserves:
- Non-sovereignty of meaning
- Space for felt revision before articulated revision
- Why silence can be healthy
- Why "nothing I can say feels right yet" is a real state
