...
elemental_mapping:
  ...
  earth: 0.70
status: canonical
siml_entry: https://github.com/memeticcowboy/nema-swarm/tree/main/SIML/terms/C021_scientist_mindset
---
...
The scientist mindset counters:
- **Confirmation bias:** Seeking only confirming evidence
- **Defensive reasoning:** Protecting existing beliefs
- **Authority dependence:** Accepting claims without verification
