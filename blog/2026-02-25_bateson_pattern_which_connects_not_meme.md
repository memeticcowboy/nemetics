...
In nemetic terms, this is **nemetic capture**:
- A pattern that **coordinates substrates** (bodies, affects, linguistic habits, expectations) into a **self-reinforcing loop**
- Any attempt to step out of the pattern is **already coded as failure, betrayal, or pathology**
...
This is almost **proto-memetics**, but in a crucially different register:
- **Not** countable discrete memes
- **But** circuits and complexes of difference, **the weave itself**

### What Bateson Studied

He is interested in:
- How **patterns of distinction and response** stabilize, amplify, or destroy systems
- How an **ecology of mind** can be healthy or pathological
- **Not** the replication statistics of particular ideas [3]
...
His "ecology of mind" and "difference that makes a difference" give you an **early, rigorous account of nematic operation**:
- Information and mind as **distributed, relational patterning**
- The double bind as a **paradigmatic case** where that patterning becomes a **trap** rather than a space of viable coordination
