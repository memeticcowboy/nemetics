...
**For NEMAtics**, consciousness requires:
1. **Bow-tie topology** (compression/expansion)
2. **ε-preservation** (uncertainty maintained)
3. **Ω-permeability** (openness to surprise)
