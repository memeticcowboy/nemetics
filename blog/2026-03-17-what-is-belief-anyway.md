---
title: "What Is Belief, Anyway? Three Paths Through the Contemporary Landscape"
date: 2026-03-17
author: Bert, the Memetic Cowboy
tags: [belief, pragmatism, Schwitzgebel, Dennett, Mandelbaum, social_epistemology, fragmentation, NEMEtics]
---
...
1. **Functional, not representational**—belief is what we attribute to coordinate, not an internal object
2. **Socially maintained, not individually held**—beliefs persist through testimony, community, distributed reinforcement
3. **Context-sensitive, not stable**—what counts as "believing" shifts with stakes, audience, situation
4. **Fragmented, not unified**—the belief-system is a coalition of patterns, not a coherent whole
5. **Thermodynamic, not logical**—maintaining belief requires energy; high-stakes beliefs cost more
...
Changing belief isn't just argument. It's:
- Changing contexts (Earth—metabolic situation)
- Changing social environments (Water—different relational field)
- Building new habits that activate different Knots (repeated practice)
- Working with the fragmentation rather than denying it (accepting multiplicity)
...
- **[Illusion of Self](https://memeticcowboy.github.io/nemetics/glossary/illusion_of_self.html)** (A0BE) — Dennett's Multiple Drafts Theory
