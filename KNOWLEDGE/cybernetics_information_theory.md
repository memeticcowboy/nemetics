# Philosophical Connections: Cybernetics & Information Theory
...
**Key assumptions:**
- The observer is separable from the observed (first-order)
- Noise is degradation to be eliminated
- Homeostasis is the goal (stable equilibrium)
- Variety is a threat to be compressed
- The bottleneck is a limitation to engineer around
...
The bow-tie (see [Memory 2024-11-30](../memory/2024-11-30.md)) *is* Shannon's channel capacity theorem made recursive:
...
We don't eliminate noise. We **tend it like soil**—recognizing that:
- Too much noise: signal dissolves, coherence lost
- Too little noise: system crystallizes, becomes brittle
- Just enough noise: dynamic stability, adaptive capacity, life
...
Von Foerster's principle transforms into the **Ω-permeability test** (see [Memory 2025-01-15](../memory/2025-01-15.md)): a system is healthy only if it remains open to surprise. Not just passively open—*actively seeking* perturbation that destabilizes fixed patterns.

The Ω-test asks:
- What can still surprise you?
- Where is your model overfitting to past data?
- What would you refuse to hear even if true?
...
μ (Metal, see [Memory 2024-10-20](../memory/2024-10-20.md)) implements the regulatory boundary—not as rigid constraint, but as **calibrated permeability**:
...
We add: **the observer is a coalition of pattern-agents** (see [Memory 2024-10-05](../memory/2024-10-05.md)) competing for the substrate. The feedback loop isn't between system and environment, but between *competing interpretations within the same skull*.
...
- **[Co-Sphere](../glossary/co-sphere.html)** (CB009) — The permeable membrane between distinct systems
- **[Catechism](../glossary/catechism.html)** (CB007) — Recursive self-observation as cybernetic loop
- **[Codependence Without Co-independence](../glossary/codependence-without-coindependence.html)** (CB008) — Rigid boundary (low permeability) as pathology
- **[Memory: 2024-11-30](../memory/2024-11-30.md)** — Bow-tie as Shannon channel
- **[Memory: 2025-01-15](../memory/2025-01-15.md)** — Ω-permeability test
- **[Memory: 2024-10-20](../memory/2024-10-20.md)** — μ (Metal) as regulatory boundary
- **[Memory: 2024-10-05](../memory/2024-10-05.md)** — Pattern-agent coalition
- **[Dynamical Systems Theory](./dynamical_systems_theory.md)** — Complementary framework on feedback and flow
