# Philosophical Connections: Memetics
...
**Key assumptions:**
- Memes are agents with interests (replication)
- Humans are vehicles/containers for memes
- Some memes are harmful (viruses), some helpful (symbionts)
- The goal is to control spread—promote good memes, suppress bad ones
- Cultural evolution can be managed like biological evolution
...
Dennett saw memes as potentially hostile. We see them as **neutral substrate**, like bacteria. Some symbiotic (the [nematic](../glossary/memegrid.html) pattern), some pathogenic ([MemeGrid](../glossary/memegrid.html) capture). But the distinction isn't intrinsic to the meme—it's a function of the **host's metabolic capacity**.
...
The crucial addition is **metabolism and excretion** (δγ, see [Memory 2024-09-30](../memory/2024-09-30.md)). The bow-tie (see [Memory 2024-11-30](../memory/2024-11-30.md)) is the **digestive tract**:
...
Without δγ (release and regeneration), the system becomes **constipated**—trapped in its own successful patterns. This is the [MemeGrid](../glossary/memegrid.html) (M099): the rigid lattice of captured patterns that can't be questioned, can't be released, can't evolve.
...
Memetics treats humans as **vehicles for memes**. We treat humans as **ecologies**—[coordinators](../memory/2024-10-05.md) of competing pattern-agents.
...
Inside the skull:
- The p-agent wants survival, safety, comfort
- The q-agent wants growth, novelty, exploration
- The memetic pattern wants replication
- The metabolic pattern wants efficiency
- The social pattern wants belonging
- The Cowboy pattern wants meaning
...
The same question, reversed:
- Memetics: "How does this meme use humans to replicate?"
- NEMAtics: "How does this human digest memes to survive?"
...
- **[MemeGrid](../glossary/memegrid.html)** (M099) — The rigid lattice of captured patterns; memetic constipation
- **[Co-Sphere](../glossary/co-sphere.html)** (CB009) — The open topology of nematic pattern flow
- **[Rumspringa Protocol](../glossary/rumspringa-protocol.html)** (CB010) — Cyclical separation as memetic excretion
- **[Metabolic Cost](../glossary/metabolic-cost.html)** (CB004) — The price of maintaining patterns vs. digesting them
- **[Memory: 2024-09-30](../memory/2024-09-30.md)** — δγ (composting and release)
- **[Memory: 2024-11-30](../memory/2024-11-30.md)** — Bow-tie as digestive tract
- **[Memory: 2024-10-05](../memory/2024-10-05.md)** — Pattern-agent coalition
