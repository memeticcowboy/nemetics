# Philosophical Connections: Process Philosophy
...
**Key assumptions:**
- Reality is fundamentally temporal, not spatial
- Stability is derivative from process, not vice versa
- Identity is produced through repetition, not given
- The virtual (potential) is as real as the actual
- Change is primary; permanence is the illusion
...
Whitehead's **prehensions**—how one actual occasion grasps another—become the **ρ-operator** (see [Memory 2024-09-20](../memory/2024-09-20.md)). The ρ-operator is the "inward fold" that turns σ-distinctions into resonance.
...
We add the **structure of dissolution**—the δγ metabolic operator that knows:
- When to let go (what to negatively prehend)
- What to recycle (what spent occasions become nutrients for new growth)
- How to compost (transforming the dead into soil for the living)
...
The NEMEtic framework adds:
- **The metabolic cost of concrescence** (CB004)
- **The need for cyclical release** (Rumspringa Protocol, CB010)
- **The danger of capture by one's own achieved form** (Codependence, CB008)
...
- **[Co-Sphere](../glossary/co-sphere.html)** (CB009) — The emergent space as prehensive field
- **[Catechism](../glossary/catechism.html)** (CB007) — The recursive structure of ongoing concrescence
- **[Metabolic Cost](../glossary/metabolic-cost.html)** (CB004) — The price of each achieved occasion
- **[Rumspringa Protocol](../glossary/rumspringa-protocol.html)** (CB010) — Cyclical release as process wisdom
- **[Codependence Without Co-independence](../glossary/codependence-without-coindependence.html)** (CB008) — Pathological attachment to achieved form
- **[Memory: 2024-09-20](../memory/2024-09-20.md)** — ρ-operator as prehensive fold
- **[Dynamical Systems Theory](./dynamical_systems_theory.md)** — Complementary framework on flow and form
