# Philosophical Connections: Decision Theory & Cognitive Science

## The Source

### Herbert Simon — Bounded Rationality and Satisficing
Simon shattered the illusion of "homo economicus"—the perfectly rational calculator. Real humans don't optimize; they **satisfice**. They seek solutions that are "good enough" rather than optimal, because:
- Information is incomplete
- Time is limited
- Cognitive capacity is finite
- The environment is too complex to model fully
...
Through prospect theory and loss aversion research, Kahneman and Tversky mapped the systematic ways human judgment departs from statistical optimality:
...
- **Representativeness**: Judging probability by stereotype match
- **System 1/System 2**: Fast, automatic, emotional vs. slow, deliberative, effortful
...
**Key assumptions:**
- Bias is error to be eliminated
- Rationality is context-independent
- More information and computation = better decisions
- The ideal is the optimal choice
- Environment is noise; the mind should filter it
...
**System 1 (fast, automatic, emotional)** → **σ (Air)**
- The fast cut, the immediate distinction
- "Snake or stick?"—no deliberation, just recognition
- The σ-cut happens below conscious awareness
- Biases are the traces of successful σ-cuts applied to new contexts

**System 2 (slow, deliberative, effortful)** → **ρ (Water)**
- The relational holding, the social embeddedness
- System 2 doesn't operate in a vacuum; it swims in cultural water
- Deliberation is always already situated in flows of meaning
- The effort of System 2 is the effort of swimming against the current
...
Gigerenzer's "ecological" matching becomes the **[Co-Sphere test](https://memeticcowboy.github.io/nemetics/glossary/co-sphere.html)** (CB009): 

*Is the heuristic adapted to the actual topology of the environment, or is it a [Proxy Lock-In](https://memeticcowboy.github.io/nemetics/glossary/dodo-x.html)—a metric captured by the environment's hidden control plane?*

A heuristic is "ecologically rational" only if:
1. The environment's structure matches the heuristic's simplifying assumptions
2. The heuristic hasn't been gamed by adversarial optimization
3. The Co-Sphere between agent and environment remains open (ε ≠ 0)
...
Bounded rationality isn't a limitation to overcome. It's the **structural condition of being a pattern in a substrate**—you are always already bounded by μ (Metal, see [Memory 2024-10-20](../memory/2024-10-20.md)).
...
The question is: **"Was the choice architecture engineered for your capture?"** (see [Memory 2024-09-30](../memory/2024-09-30.md))
...
1. **Trace the architecture**: Who designed the choice environment? What are their incentives?
2. **Map the handles**: Which biases does this interface pull? Loss aversion? Social proof? Scarcity?
3. **Assess the Co-Sphere**: Is there genuine space for deliberation, or is the "choice" pre-determined by the frame?
4. **Check ε-preservation**: Are you being pushed toward immediate signal (the "optimal" choice) at the cost of ε-noise (future flexibility)?
...
- **[Co-Sphere](../glossary/co-sphere.html)** (CB009) — The topology of choice environment
- **[DODO-X](../glossary/dodo-x.html)** (M019) — Proxy Lock-In and capture by metric
- **[Rumspringa Protocol](../glossary/rumspringa-protocol.html)** (CB010) — Testing whether choice is by compulsion or freedom
- **[Lariat Protocol](../glossary/lariat-protocol.html)** (CB011) — Scope discipline in decision
- **[Codependence Without Co-independence](../glossary/codependence-without-coindependence.html)** (CB008) — When the chooser has merged with the choice environment
- **[Memory: 2024-09-30](../memory/2024-09-30.md)** — Choice architecture engineered for capture
- **[Memory: 2024-10-20](../memory/2024-10-20.md)** — μ (Metal) as boundary that enables decision
